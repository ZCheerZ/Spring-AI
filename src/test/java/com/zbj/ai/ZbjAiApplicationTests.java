...
import com.zbj.ai.utils.VectorDistanceUtils;
...
class ZbjAiApplicationTests {
	...
	@Test
	void contextLoads() {
		float[] embed = embeddingModel.embed("你好，左璧嘉");
	...
	public void testVectorStore(){
		Resource resource = new FileSystemResource("D:\\learning-project\\黑马-SpringAI+DeepSeek大模型应用开发实战视频教程\\课程资料\\代码\\中二知识笔记.pdf");
		// 1.创建PDF的读取器
